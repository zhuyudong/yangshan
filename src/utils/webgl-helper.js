...
export function createShaderFromScript(gl, type, source) {
...
export function createSimpleProgramFromScript(
  gl,
  vertexScriptId,
  fragmentScriptId
) {
...
export function createBufferInfoFromObject(gl, object) {
  ...
  if (indices) {
    ...
    bufferInfo.indices = createWebGLBuffer(gl, indices, gl.ELEMENT_ARRAY_BUFFER)
